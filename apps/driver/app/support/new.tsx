      ...
      >
        ...
        >
          ...
          <View className="mb-5 h-14 flex-row items-center gap-2 rounded-xl border border-neutral-200 bg-white px-4 dark:border-neutral-700 dark:bg-neutral-800">
            <MaterialIcons name="title" size={20} color={driverNavy[400]} />
            <TextInput
              className="h-full flex-1 font-plex text-base text-neutral-900 dark:text-neutral-50"
              placeholder={t('support.form.subjectPlaceholder', 'مثال: مشكلة في رفع المستندات')}
          ...
          <View className="mb-5 flex-row flex-wrap gap-2">
            {categories.map((c) => {
              ...
              return (
                ...
                >
                  <MaterialIcons name={c.icon} size={16} color={active ? '#ffffff' : driverNavy[400]} />
                  <Text
