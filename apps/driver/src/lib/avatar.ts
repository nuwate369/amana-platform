...
/**
 * اختيار ورفع صورة المستخدم إلى bucket «avatars» (عام) ثم تحديث
 * profiles.avatar_url وبيانات المصادقة. رفع مباشر (بلا base64) وبلا قصّ إجباري
 * (الإطار الدائري يقصّ الصورة بصريًّا بـ cover) — نفس نمط KYC الموثوق.
...
export async function pickAndUploadAvatar(
  ...
  // 1) الصلاحية + فتح المصدر المناسب (بلا allowsEditing — نتفادى محرّر القصّ
  //    الأصلي في أندرويد الذي قد يُنتج رابطًا لا يُقرأ جيدًا).
