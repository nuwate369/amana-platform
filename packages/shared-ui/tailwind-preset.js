  ...
  return {
    theme: {
      extend: {
        ...
        boxShadow: {
          xs: '0 2px 4px rgba(20,23,28,0.03)',
          sm: '0 4px 12px rgba(20,23,28,0.05), 0 2px 4px rgba(20,23,28,0.03)',
          DEFAULT: '0 8px 24px rgba(20,23,28,0.08), 0 4px 12px rgba(20,23,28,0.04)',
          lg: '0 16px 48px rgba(20,23,28,0.1), 0 8px 24px rgba(20,23,28,0.06)',
          pop: '0 32px 64px rgba(139,79,216,0.15), 0 16px 32px rgba(139,79,216,0.1)',
        },
      },
    },
  };
